...
function VideoSelector() {
  ...
  return (
    <div onDrop={onDrop} onDragEnter={onDrag} onDragOver={onDrag} onDragLeave={onDrag} className='VideoSelector'>
      <div className={`VideoDragSelector ${!dragActive ? "hidden" : ""} `} />

      <button onClick={onClick} className='default-button'>
        <img className='inline-block align-top' src={pressplay.src} width='30px' alt='Press Play icon' />
        &nbsp;
